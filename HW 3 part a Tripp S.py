...
"""The Cholesky decomposition function implements the rule of changing A to LL^T the downside
being it has to be symmetrical and be positive definite."""

"""Both forward and backward substitution determine the y and x value respectively."""
...
"""The doolittle decomposition is used as a back up in case the cholesky method is unable to be used."""
...
"""This function below determines if the function fits the criteria to use cholesky on it. Otherwise it will use
the doolittle equations instead."""
...
"""The equation above executes the respective methods after it is determined which method is to be used.
The equations below are simply to declare the arrays and the print configuration for the answer."""
